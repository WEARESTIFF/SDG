...
if ( !function_exists( 'hb_recognized_icons' ) ) {
    ...
    function hb_recognized_icons() {
        ...
        # file to load
        $subject = file_get_contents( HB_THEME_URL .'/font-awesome-4.2.0/css/font-awesome.css' );
...
//         # file to load
//         $subject = file_get_contents( HB_THEME_URL .'/inc/ionicons-1.5.2/css/ionicons.css' );
...
if ( !function_exists( 'hb_recognized_glyphicon_icons' ) ) {
    ...
    function hb_recognized_glyphicon_icons( $icons = array() ) {
        ...
        # file to load
        $subject = file_get_contents( HB_THEME_URL .'/bootstrap-3.3.1/css/bootstrap.only.fonts.css' );
